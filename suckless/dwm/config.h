...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_p,      spawn,          SHCMD("power_menu") },
	{ MODKEY|ShiftMask,             XK_b,      spawn,          SHCMD("qutebrowser") },
	{ 0,         XF86XK_AudioRaiseVolume,      spawn,          SHCMD("ctrl-volume out -inc") },
	{ 0,         XF86XK_AudioLowerVolume,      spawn,          SHCMD("ctrl-volume out -dec") },
	{ 0,                XF86XK_AudioMute,      spawn,          SHCMD("ctrl-volume out -mute") },
	{ ShiftMask, XF86XK_AudioRaiseVolume,      spawn,          SHCMD("ctrl-volume in -inc") },
	{ ShiftMask, XF86XK_AudioLowerVolume,      spawn,          SHCMD("ctrl-volume in -dec") },
	{ ShiftMask,        XF86XK_AudioMute,      spawn,          SHCMD("ctrl-volume in -mute") },
